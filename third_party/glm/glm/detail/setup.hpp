...
#if defined(_M_ARM64) || defined(__LP64__) || defined(_M_X64) ||               \
    defined(__ppc64__) || defined(__x86_64__)
#define GLM_MODEL GLM_MODEL_64
#elif defined(__i386__) || defined(__ppc__) || defined(__ILP32__) ||           \
    defined(_M_ARM)
...
#define GLM_LANG (GLM_LANG_CXX17 | GLM_LANG_EXT)
#elif __cplusplus == 201402L || __cplusplus == 201500L ||                      \
    GLM_LANG_PLATFORM == 201402L
#define GLM_LANG (GLM_LANG_CXX14 | GLM_LANG_EXT)
#elif __cplusplus == 201103L || GLM_LANG_PLATFORM == 201103L
#define GLM_LANG (GLM_LANG_CXX11 | GLM_LANG_EXT)
#elif defined(__INTEL_CXX11_MODE__) || defined(_MSC_VER) ||                    \
...
#if (GLM_ARCH &                                                                \
     GLM_ARCH_SIMD_BIT) // Compiler SIMD intrinsics don't support constexpr...
...
#define GLM_HAS_CONSTEXPR                                                      \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && GLM_HAS_INITIALIZER_LISTS &&            \
   (((GLM_COMPILER & GLM_COMPILER_INTEL) &&                                    \
     (GLM_COMPILER >= GLM_COMPILER_INTEL17)) ||                                \
    ((GLM_COMPILER & GLM_COMPILER_VC) &&                                       \
     (GLM_COMPILER >= GLM_COMPILER_VC15))))
#endif
...
#define GLM_HAS_BITSCAN_WINDOWS                                                \
  ((GLM_PLATFORM & GLM_PLATFORM_WINDOWS) &&                                    \
   (((GLM_COMPILER & GLM_COMPILER_INTEL)) ||                                   \
    ((GLM_COMPILER & GLM_COMPILER_VC) &&                                       \
     (GLM_COMPILER >= GLM_COMPILER_VC14) && (GLM_ARCH & GLM_ARCH_X86_BIT))))
#else
...
#define GLM_CLIP_CONTROL_LH_BIT                                                \
  (1 << 2) // LEFT_HANDED, For DirectX, Metal, Vulkan
#define GLM_CLIP_CONTROL_RH_BIT                                                \
  (1 << 3) // RIGHT_HANDED, For OpenGL, default in GLM

#define GLM_CLIP_CONTROL_LH_ZO                                                 \
  (GLM_CLIP_CONTROL_LH_BIT | GLM_CLIP_CONTROL_ZO_BIT)
#define GLM_CLIP_CONTROL_LH_NO                                                 \
  (GLM_CLIP_CONTROL_LH_BIT | GLM_CLIP_CONTROL_NO_BIT)
#define GLM_CLIP_CONTROL_RH_ZO                                                 \
  (GLM_CLIP_CONTROL_RH_BIT | GLM_CLIP_CONTROL_ZO_BIT)
#define GLM_CLIP_CONTROL_RH_NO                                                 \
  (GLM_CLIP_CONTROL_RH_BIT | GLM_CLIP_CONTROL_NO_BIT)
...
template <> struct make_unsigned<int64> {
  typedef uint64 type;
};
...
template <> struct make_unsigned<uint64> {
  typedef uint64 type;
};
} // namespace detail
} // namespace glm
...
#elif defined(GLM_FORCE_PRECISION_MEDIUMP_BOOL) ||                             \
...
#if defined(GLM_FORCE_PRECISION_HIGHP_FLOAT) ||                                \
    defined(GLM_PRECISION_HIGHP_FLOAT)
...
#elif defined(GLM_FORCE_PRECISION_LOWP_FLOAT) ||                               \
...
#if defined(GLM_FORCE_PRECISION_HIGHP_DOUBLE) ||                               \
    defined(GLM_PRECISION_HIGHP_DOUBLE)
...
#elif defined(GLM_FORCE_PRECISION_LOWP_DOUBLE) ||                              \
...
#pragma message(                                                               \
    "GLM: GLM_FORCE_SWIZZLE is defined, swizzling operators enabled.")
...
#if defined(GLM_FORCE_ALIGNED_GENTYPES) &&                                     \
    (GLM_CONFIG_ALIGNED_GENTYPES == GLM_ENABLE)
...
#elif defined(GLM_FORCE_ALIGNED_GENTYPES) &&                                   \
    (GLM_CONFIG_ALIGNED_GENTYPES == GLM_DISABLE)
#undef GLM_FORCE_ALIGNED_GENTYPES
#pragma message(                                                               \
...
#pragma message(                                                               \
    "GLM: GLM_FORCE_DEPTH_ZERO_TO_ONE is defined. Using zero to one depth clip space.")
#else
#pragma message(                                                               \
...
#pragma message(                                                               \
    "GLM: GLM_FORCE_LEFT_HANDED is defined. Using left handed coordinate system.")
#else
#pragma message(                                                               \
