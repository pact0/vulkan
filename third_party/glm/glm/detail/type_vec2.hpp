...
#pragma warning(pop)
  ...
  template <qualifier P> GLM_FUNC_DECL GLM_CONSTEXPR vec(vec<2, T, P> const &v);
  ...
  template <typename A, typename B> GLM_FUNC_DECL GLM_CONSTEXPR vec(A x, B y);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<2, T, Q> operator+(vec<2, T, Q> const &v1,
                                                   vec<1, T, Q> const &v2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<2, T, Q> operator+(T scalar,
                                                   vec<2, T, Q> const &v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<2, T, Q> operator+(vec<1, T, Q> const &v1,
                                                   vec<2, T, Q> const &v2);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR bool operator==(vec<2, T, Q> const &v1,
                                            vec<2, T, Q> const &v2);
