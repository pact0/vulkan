...
GLM_FUNC_DECL bool
intersectRayPlane(genType const &orig, genType const &dir,
...
GLM_FUNC_DECL bool
intersectRayTriangle(vec<3, T, Q> const &orig, vec<3, T, Q> const &dir,
...
template <typename genType>
GLM_FUNC_DECL bool
intersectLineTriangle(genType const &orig, genType const &dir,
...
template <typename genType>
GLM_FUNC_DECL bool
intersectRaySphere(genType const &rayStarting,
