...
///
/// Based on the AHEasing project of Warren Moore
...
template <typename genType> GLM_FUNC_DECL genType cubicEaseIn(genType const &a);
...
/// @see gtx_easing
template <typename genType> GLM_FUNC_DECL genType sineEaseIn(genType const &a);

/// Modelled after quarter-cycle of sine wave (different phase)
/// @see gtx_easing
template <typename genType> GLM_FUNC_DECL genType sineEaseOut(genType const &a);
...
/// Modelled after the damped sine wave y = sin(-13pi/2*(x + 1))*pow(2, -10x) +
/// 1
/// @see gtx_easing
template <typename genType>
...
/// y = (1/2)*sin(13pi/2*(2*x))*pow(2, 10 * ((2*x) - 1))		;
/// [0,0.5) y = (1/2)*(sin(-13pi/2*((2x-1)+1))*pow(2,-10(2*x-1)) + 2)	; [0.5,
/// 1]
/// @see gtx_easing
template <typename genType>
...
/// @see gtx_easing
template <typename genType> GLM_FUNC_DECL genType backEaseIn(genType const &a);

/// @see gtx_easing
template <typename genType> GLM_FUNC_DECL genType backEaseOut(genType const &a);
