...
/// 1 component vector aligned in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
typedef vec<1, float, aligned_highp> aligned_highp_vec1;

/// 1 component vector aligned in memory of single-precision floating-point
/// numbers using medium precision arithmetic in term of ULPs.
typedef vec<1, float, aligned_mediump> aligned_mediump_vec1;

/// 1 component vector aligned in memory of single-precision floating-point
/// numbers using low precision arithmetic in term of ULPs.
typedef vec<1, float, aligned_lowp> aligned_lowp_vec1;

/// 1 component vector aligned in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 1 component vector tightly packed in memory of single-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
typedef vec<1, float, packed_highp> packed_highp_vec1;

/// 1 component vector tightly packed in memory of single-precision
/// floating-point numbers using medium precision arithmetic in term of ULPs.
typedef vec<1, float, packed_mediump> packed_mediump_vec1;

/// 1 component vector tightly packed in memory of single-precision
/// floating-point numbers using low precision arithmetic in term of ULPs.
typedef vec<1, float, packed_lowp> packed_lowp_vec1;

/// 1 component vector tightly packed in memory of double-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
...
/// 2 components vector aligned in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 2 components vector aligned in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 2 components vector tightly packed in memory of single-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
...
/// 2 components vector tightly packed in memory of double-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
...
/// 3 components vector aligned in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 components vector aligned in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 components vector tightly packed in memory of single-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
...
/// 3 components vector tightly packed in memory of double-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
...
/// 4 components vector aligned in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 components vector aligned in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 components vector tightly packed in memory of single-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
...
/// 4 components vector tightly packed in memory of double-precision
/// floating-point numbers using high precision arithmetic in term of ULPs.
...
/// 2 by 2 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
typedef mat<2, 2, float, aligned_highp> aligned_highp_mat2;

/// 2 by 2 matrix aligned in memory of single-precision floating-point numbers
/// using medium precision arithmetic in term of ULPs.
typedef mat<2, 2, float, aligned_mediump> aligned_mediump_mat2;

/// 2 by 2 matrix aligned in memory of single-precision floating-point numbers
/// using low precision arithmetic in term of ULPs.
typedef mat<2, 2, float, aligned_lowp> aligned_lowp_mat2;

/// 2 by 2 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 2 by 2 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 2 by 2 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 by 3 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 3 by 3 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 3 by 3 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 by 3 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 by 4 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 4 by 4 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 4 by 4 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 by 4 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 2 by 3 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 2 by 3 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 2 by 3 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 2 by 3 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 2 by 4 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 2 by 4 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 2 by 4 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 2 by 4 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 by 2 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 3 by 2 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 3 by 2 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 by 2 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 by 4 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 3 by 4 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 3 by 4 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 3 by 4 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 by 2 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 4 by 2 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 4 by 2 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 by 2 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 by 3 matrix aligned in memory of single-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 4 by 3 matrix aligned in memory of double-precision floating-point numbers
/// using high precision arithmetic in term of ULPs.
...
/// 4 by 3 matrix tightly packed in memory of single-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
/// 4 by 3 matrix tightly packed in memory of double-precision floating-point
/// numbers using high precision arithmetic in term of ULPs.
...
typedef packed_mediump_mat4x4 packed_mat4x4;
      ...
      /// 1 component vector aligned in memory of single-precision
...
/// 2 by 2 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
typedef aligned_highp_mat2 aligned_mat2;

/// 3 by 3 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
typedef aligned_highp_mat3 aligned_mat3;

/// 4 by 4 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
...
/// 2 by 3 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
typedef aligned_highp_mat2x3 aligned_mat2x3;

/// 2 by 4 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
typedef aligned_highp_mat2x4 aligned_mat2x4;

/// 3 by 2 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
...
/// 3 by 4 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
typedef aligned_highp_mat3x4 aligned_mat3x4;

/// 4 by 2 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
typedef aligned_highp_mat4x2 aligned_mat4x2;

/// 4 by 3 matrix tightly aligned in memory of single-precision floating-point
/// numbers.
...
typedef packed_mediump_dmat4x4 packed_dmat4x4;
      ...
      /// 1 component vector aligned in memory of double-precision
      /// floating-point numbers.
...
/// 2 by 2 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
typedef aligned_highp_dmat2 aligned_dmat2;

/// 3 by 3 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
typedef aligned_highp_dmat3 aligned_dmat3;

/// 4 by 4 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
...
/// 2 by 3 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
typedef aligned_highp_dmat2x3 aligned_dmat2x3;

/// 2 by 4 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
typedef aligned_highp_dmat2x4 aligned_dmat2x4;

/// 3 by 2 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
...
/// 3 by 4 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
typedef aligned_highp_dmat3x4 aligned_dmat3x4;

/// 4 by 2 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
typedef aligned_highp_dmat4x2 aligned_dmat4x2;

/// 4 by 3 matrix tightly aligned in memory of double-precision floating-point
/// numbers.
