...
/// @ingroup ext
///
/// Exposes comparison functions for scalar types that take a user defined
/// epsilon values.
///
/// Include <glm/ext/scalar_relational.hpp> to use the features of this
/// extension.
///
...
/// @param ULPs Maximum difference in ULPs between the two operators to consider
/// them equal.
///
/// @tparam genType Floating-point or integer scalar types
template <typename genType>
