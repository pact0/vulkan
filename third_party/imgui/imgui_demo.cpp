...
void ImGui::ShowDemoWindow(bool *p_open) {
  ...
  if (ImGui::BeginMenuBar()) {
    ...
    if (ImGui::BeginMenu("Tools")) {
      ...
      ImGui::MenuItem("ID Stack Tool", NULL, &show_tool_id_stack_tool,
                      has_debug_tools);
      ...
      if (!is_debugger_present)
        ImGui::SetItemTooltip(
            ...
            "otherwise disable the menu option to avoid casual users crashing "
            "the application.\n\nYou can however always access the Item Picker "
            "in Metrics->Tools.");
      ImGui::Separator();
...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Tooltips")) {
    ...
    HelpMarker("Passing ImGuiHoveredFlags_ForTooltip to IsItemHovered() is the "
  ...
  if (ImGui::TreeNode("Tree Nodes")) {
    ...
    if (ImGui::TreeNode("Advanced, with Selectable nodes")) {
      ...
      ImGui::CheckboxFlags("ImGuiTreeNodeFlags_SpanTextWidth", &base_flags,
  ...
  if (ImGui::TreeNode("Text")) {
    ...
    if (ImGui::TreeNode("UTF-8 Text")) {
      ...
      ImGui::TextWrapped("CJK text will only appear if the font was loaded "
  ...
  if (ImGui::TreeNode("Images")) {
    ...
    float my_tex_h = (float)io.Fonts->TexHeight;
    {
      ...
      if (ImGui::BeginItemTooltip()) {
        ...
        ImGui::Image(my_tex_id, ImVec2(region_sz * zoom, region_sz * zoom), uv0,
  ...
  if (ImGui::TreeNode("Text Input")) {
    ...
    if (ImGui::TreeNode("Completion, History, Edit Callbacks")) {
      ...
      HelpMarker("Here we append \"..\" each time Tab is pressed. "
                 "See 'Examples>Console' for a more meaningful demonstration "
  ...
  if (ImGui::TreeNode("Plotting")) {
    ...
    ImGui::PlotLines("Lines", func, NULL, display_count, 0, NULL, -1.0f, 1.0f,
                     ImVec2(0, 80));
    ImGui::PlotHistogram("Histogram", func, NULL, display_count, 0, NULL, -1.0f,
                         1.0f, ImVec2(0, 80));
    ImGui::Separator();
...
static void ShowDemoWindowLayout() {
  ...
  if (ImGui::TreeNode("Scrolling")) {
    ...
    ImGui::SameLine(140);
    scroll_to_pos |= ImGui::DragFloat("##pos", &scroll_to_pos_px, 1.00f, -10,
                                      FLT_MAX, "X/Y = %.0f px");
    ImGui::PopItemWidth();
    ...
    if (show_horizontal_contents_size_demo_window) {
      ...
      HelpMarker("Test how different widgets react and impact the work "
  ...
  if (ImGui::TreeNode("Overlap Mode")) {
    ...
    HelpMarker("Hit-testing is by default performed in item submission order, "
               ...
               "Doing so alters the hovering logic: items using AllowOverlap "
               "mode requires an extra frame to accept hovered state.");
...
static void ShowDemoWindowTables() {
  ...
  if (ImGui::TreeNode("Basic")) {
    ...
    HelpMarker("Only using TableNextColumn(), which tends to be convenient for "
               ...
               "the same type of contents.\n This is also more similar to the "
               "old NextColumn() function of the "
               "Columns API, and provided to facilitate the Columns->Tables "
               "API transition.");
  ...
  if (ImGui::TreeNode("Sizing policies")) {
    ...
    if (contents_type == CT_FillButton) {
      ...
      HelpMarker("Be mindful that using right-alignment (e.g. size.x = "
                 ...
                 "where contents width can feed into auto-column width can "
  ...
  if (ImGui::TreeNode("Horizontal scrolling")) {
    HelpMarker("When ScrollX is enabled, the default sizing policy becomes "
               ...
               "as automatically stretching columns doesn't make much sense "
  ...
  if (ImGui::TreeNode("Tree view")) {
    ...
    static ImGuiTreeNodeFlags tree_node_flags =
        ImGuiTreeNodeFlags_SpanAllColumns;
    ImGui::CheckboxFlags("ImGuiTreeNodeFlags_SpanFullWidth", &tree_node_flags,
                         ImGuiTreeNodeFlags_SpanFullWidth);
    ImGui::CheckboxFlags("ImGuiTreeNodeFlags_SpanTextWidth", &tree_node_flags,
                         ImGuiTreeNodeFlags_SpanTextWidth);
    ImGui::CheckboxFlags("ImGuiTreeNodeFlags_SpanAllColumns", &tree_node_flags,
                         ImGuiTreeNodeFlags_SpanAllColumns);
  ...
  if (ImGui::TreeNode("Item width")) {
    HelpMarker("Showcase using PushItemWidth() and how it is preserved on a "
               "per-column basis.\n\n"
  ...
  if (ImGui::CollapsingHeader("Inputs & Focus")) {
    ...
    if (ImGui::TreeNode("Outputs")) {
      HelpMarker("The value of io.WantCaptureMouse and io.WantCaptureKeyboard "
                 "are normally set by Dear ImGui "
      ...
      if (ImGui::Button("Export")) {
        ...
        for (int i = 0; i < ImGuiCol_COUNT; i++) {
          ...
          if (!output_only_modified ||
            ...
            ImGui::LogText("colors[ImGuiCol_%s]%*s= ImVec4(%.2ff, %.2ff, "
                           "%.2ff, %.2ff);" IM_NEWLINE,
  ...
  if (ImGui::BeginTabBar("##TabBar")) {
    if (ImGui::BeginTabItem("Primitives")) {
      ...
      for (int n = 0; n < 2; n++) {
        ...
        // draw_list->AddPolyline(concave_shape, IM_ARRAYSIZE(concave_shape),
        // col, ImDrawFlags_Closed, th);
...
struct ExampleAppDocuments {
  ...
  ExampleAppDocuments() {
    Documents.push_back(
        MyDocument("Lettuce", true, ImVec4(0.4f, 0.8f, 0.4f, 1.0f)));
    Documents.push_back(
        MyDocument("Eggplant", true, ImVec4(0.8f, 0.5f, 1.0f, 1.0f)));
    Documents.push_back(
        MyDocument("Carrot", true, ImVec4(1.0f, 0.8f, 0.5f, 1.0f)));
    Documents.push_back(
        MyDocument("Tomato", false, ImVec4(1.0f, 0.3f, 0.4f, 1.0f)));
