...
static VOID _setVisibleRegion(WINDATA *pWinData, BOOL fVisible)
{
    ...
    pWinData->pOutput->SetVisibleRegion(pWinData->pVOData, pWinData->hwnd,
                                        (pSDLDisplay == NULL) ? NULL : &pSDLDisplay->current_mode,
...
static MRESULT EXPENTRY wndProc(HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2)
{
    ...
    return (pWinData->fnUserWndProc != NULL) ? pWinData->fnUserWndProc(hwnd, msg, mp1, mp2) : WinDefWindowProc(hwnd, msg, mp1, mp2);
}
                              ...
                              SDL_WindowShapeMode *shape_mode)
{
    ...
    pWinData->hrgnShape = (stShapeRects.pRects == NULL) ? NULLHANDLE : GpiCreateRegion(hps, stShapeRects.cRects, stShapeRects.pRects);
